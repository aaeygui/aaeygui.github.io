...
<div class="home-hero">
  <h1>Baja R/C Competition Car</h1>
  <p>College senior project: Designing and building a high-performance R/C car chassis and drivetrain for ASME Baja competition</p>
...
<section id="projects">
  ...
  <div class="post-card">
    <div class="post-image">
      <span>Drivetrain Analysis</span>
    </div>
    <div class="post-content">
      <h2>7.2V Brushed Motor Drivetrain</h2>
      <p>Optimized drivetrain achieving 20 mph for Slalom-and-Sprint races with detailed RPM and torque analysis.</p>
      <a href="/analysis" class="read-more">Learn More →</a>
    </div>
  </div>
